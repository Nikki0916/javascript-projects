...
console.log("Enter the number of astronauts aboard (up to a maximum of 7):");

while (true) {
   numAstronauts = "Number of astronauts aboard:";

   if (!isNaN(numAstronauts) && numAstronauts >= 0 && numAstronauts <= 7) {
      break; 
   } else 
      console.log("Invalid input. Please enter a non-negative integer value up to a maximum of 7.");{
    break;
      }
