...
} else if (engineTemperature > 3500) {
  console.log("ENGINE FAILURE IMMINENT!");
} else engineIndicatorLight == "red blinking" {
  console.log("ENGINE FAILURE IMMINENT!");
}
...
if (fuelLevel < 1000) {
    ...
    console.log("ENGINE FAILURE IMMINENT!"); 
  } else("Fuel and engine status pending...")
