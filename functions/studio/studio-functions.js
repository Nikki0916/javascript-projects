...
// let stringToReverse = 'apple';
// let stringToReverse = 'LC101';
// let stringToReverse = 'Capitalized Letters';
let stringToReverse = 'I love the smell of code in the morning.';
...
function reversedArray(originalArray){
    ...
    for (i = 0; i < originalArray.length; i++){
        reversedArray.push(reverseCharacters(originalArray[i]));
